...
public class DatabaseManager {
    ...
    public DatabaseManager(Path dbPath) { this(dbPath.toAbsolutePath().toString()); }
    public DatabaseManager(String dbPath) { this.dbUrl = "jdbc:sqlite:" + dbPath; initializeDatabase(); }
        ...
        try (Connection conn = getConnection(); Statement stmt = conn.createStatement()) {
            ...
            stmt.execute("""
                CREATE TABLE IF NOT EXISTS books (
                    ...
                    sequence_number INTEGER, file_name TEXT, folder TEXT,
                    archive_entry TEXT, language TEXT, file_size INTEGER,
                    keywords TEXT, annotation TEXT, rate INTEGER DEFAULT 0,
